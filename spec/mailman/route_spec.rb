  ...
  describe 'conditions' do
    ...
    it 'should compile and set the condition' do
      @conditions.each do |condition|
        ...
        compiled = @route.compile_condition('test')
        @route.instance_variable_get("@#{condition}_pattern").should == compiled[0]
        @route.instance_variable_get("@#{condition}_params").should  == compiled[1]
      end
    end
